...
<html lang="en-US">
    ...
    <body marginheight="0" topmargin="0" marginwidth="0" style="margin: 0px; background-color: #f2f3f8;" leftmargin="0">
                                ...
                                <table id="long" width="10%" border="0" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            <h1 id="unavailable" style="color:#1e1e2d; font-weight:600; margin:0;font-size:28px;font-family:'Rubik',sans-serif;">Unavailable for legal reasons</h1>
                                            <span
                                                style="display:inline-block; vertical-align:middle; margin:29px  26px; border-bottom:1px solid #cecece; width:400px;"></span>
                                            <table align="center">
                                                <tr>
                                                    <td>
                                                        <h2 id="what">What does this mean?</h6>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <h3 id="unavailable_body">Nextflow services are unavailable in China. If you reside in China, you cannot access this service due to legal restrictions. If you are not in China, please contact us.</h3>
                                                    </td>
                                                </tr>
                                            </table>
                                            <button class="button1" id="submit"> Translate </button>
        ...
        <script>
            let chineseLocal = localStorage.getItem('chinese');
            let chinese;
            let button = document.getElementById('submit');
            let unavailable = document.getElementById('unavailable');
            let what = document.getElementById('what');
            let unavailable_body = document.getElementById('unavailable_body');

            if (chineseLocal === 'true') {
                chinese = true;
                unavailable.textContent = '由于法律原因不可用';
                what.textContent = '这是什么意思？';
                unavailable_body.textContent = 'Nextflow服务在中国不可用。如果您居住在中国，由于法律限制，您将无法访问此服务。如果您不在中国，请与我们联系。';
                button.textContent = ' Translate '
            } else {
                chinese = false;
                unavailable.textContent = 'Unavailable for legal reasons';
                what.textContent = 'What does this mean?';
                unavailable_body.textContent = 'Nextflow services are unavailable in China. If you reside in China, you cannot access this service due to legal restrictions. If you are not in China, please contact us.';
